...
document.addEventListener("DOMContentLoaded", function() {
	var eventForm = document.querySelector(".new-event-form");
	var eventContainer = document.querySelector(".event-container");
	var eventsList = eventContainer.querySelector(".events");
	var submitButton = eventForm.querySelector(".submit-event");

	submitButton.addEventListener("click", function(event) {
		event.preventDefault();

		var dateInput = eventForm.querySelector("#new-event-date").value;
		var descInput = eventForm.querySelector("#new-event-desc").value;

		if (dateInput && descInput) {
			var eventItem = document.createElement("div");
			eventItem.classList.add("event-item");
			eventItem.innerHTML = "<span class='event-date'>" + dateInput + "</span> - <span class='event-desc'>" + descInput + "</span>";
	...
	var addEventButton = eventContainer.querySelector(".show-event-form");
	var eventFormToggle = function() {
		eventForm.classList.toggle("hidden");
		addEventButton.classList.toggle("rotate");
	};

	addEventButton.addEventListener("click", eventFormToggle);
});
...
function showEvents() {
	...
	// Remove "active-event" class from all day elements
	[...days].forEach(day => day.classList.remove('active-event'));
...
// Assuming you have HTML elements with the IDs "submit-button", "event-form", and "events-list"
